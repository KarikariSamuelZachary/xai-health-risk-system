  ...
  return (
    <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.06)] border border-[#e8eef2] dark:border-gray-700 overflow-hidden">
      <div className="p-6 border-b border-[#e8eef2] dark:border-gray-700 bg-gradient-to-r from-white to-gray-50 dark:from-surface-dark dark:to-surface-dark">
        ...
        {patientProfile && (
          <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-2 text-sm text-primary dark:border-primary/30 dark:bg-primary/15">
            <span className="text-base leading-none">🧬</span>
            <span className="font-semibold">Patient Profile:</span>
            <span className="text-[#0f151a] dark:text-white">{patientProfile}</span>
          </div>
        )}
